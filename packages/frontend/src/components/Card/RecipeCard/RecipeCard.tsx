...
import { card, hr, socials, meta, text } from './RecipeCard.anim';
import { DataType } from './RecipeCard.d';
    ...
    <svg viewBox='0 0 32 32' version='1.1' xmlns='http://www.w3.org/2000/svg'>
      ...
      <g id='SVGRepo_iconCarrier'>
        ...
        >
          <g
            id='Icon-Set-Filled'
            transform='translate(-206.000000, -413.000000)'
            fill='#ffffff20'
          >
            <path
...
const RecipeCard: FC<DataType> = (data: DataType) => {
